...
define('HASH_THEMES_CUSTOMIZER_URL', get_template_directory_uri() . '/inc/custom-controls/');
define('HASH_THEMES_CUSTOMIZER_PATH', get_template_directory() . '/inc/custom-controls/');
