...
class Hash_Themes_Multiple_Selectize_Control extends WP_Customize_Control {
    ...
    public $type = 'hash-themes-multiple-selectize';
    public $placeholder;
    ...
    public function render_content() {
        ...
        <label>
            ...
            <select data-placeholder="<?php echo esc_html($this->placeholder); ?>" multiple="multiple" class="hash-themes-selectize" <?php $this->link(); ?>>
                <?php
