...
(function ($) {
    $.ClassyGradient = function (element, options) {
        ...
        this.getCSS = function () {
            ...
            out += 'background: ' + '-hash-themes-linear-gradient(' + defDir + ',' + defCss + ');' + '\n';
        ...
        this._selectPoint = function (el) {
            ...
            if (parseInt($(el).css('left')) < 130) {
                $element.find('.info').css('marginLeft', parseInt($(el).css('left')) - 30 + 'px').show('fast').removeClass('rightindent');
            } else {
                $element.find('.info').css('marginLeft', parseInt($(el).css('left')) - 160 + 'px').show('fast').addClass('rightindent');
            }
        };
        ...
        this._renderToElement = function (target, gradient) {
            ...
            target.css('background', '-hash-themes-linear-gradient(' + defDir + ',' + defCss + ')');
